...
define('ace/mode/trs_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/worker/mirror', 'ace/mode/trs/trs_parse'], function(require, exports, module) {


var oop = require("../lib/oop");
var Mirror = require("../worker/mirror").Mirror;
var parse = require("./trs/trs_parse");

var TrsWorker = exports.TrsWorker = function(sender) {
    Mirror.call(this, sender);
    this.setTimeout(200);
};

oop.inherits(TrsWorker, Mirror);
...
define('ace/mode/trs/trs_parse', ['require', 'exports', 'module' ], function(require, exports, module) {
...
// Return the trs_parse function. It will have access to all of the above
